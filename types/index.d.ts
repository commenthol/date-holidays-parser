declare module 'date-holidays-parser' {
  ...
  export default class Holidays {
    constructor(data: object, opts?: HolidaysTypes.Options);
    constructor(data: object, country: HolidaysTypes.Country | string, opts?: HolidaysTypes.Options);
    constructor(data: object, country: HolidaysTypes.Country | string, state: string, opts?: HolidaysTypes.Options);
    constructor(data: object, country: HolidaysTypes.Country | string, state: string, region: string, opts?: HolidaysTypes.Options);
